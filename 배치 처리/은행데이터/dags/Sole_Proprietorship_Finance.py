...
schema = 'raw_data'
table = 'sole_proprietorship_finance'
...
def get_data():
    ...
    all_data = []
    # 개인 사업자 재무 정보 조회
    base_url = 'https://apis.data.go.kr/1160100/service/GetSBFinanceInfoService/getFnafInfo?serviceKey=YeAuEKy2TOoVsF8mQ72JLW0%2FRj17Xa8JeFqJGO6DZoTiCVsbNGeGJY6oyqi8ZfwEJWWxDpM37pbe22VMFtE5wg%3D%3D'
    ...
    df = df[['OFFER_DATE', 'GENDER', 'AGE_GROUP', 'ESTABLISHED_YEAR', 'REGION', 'INDUSTRY_CD', 'INDUSTRY_NM', 'EMPLOYEE_NUM','FINANCE_STRD_YEAR','CAPITAL_AMT','SALE_AMT','OPERATING_PROFIT','NET_INCOME','TOTAL_ASSETS','TOTAL_DEBT']]
...
with DAG(
    dag_id='sole_proprietorship_finance',
