...
schema = 'raw_data'
table = 'jeonse_rent_change_rate_size'
...
def get_data():
    data_list = []
    base_url = "https://api.odcloud.kr/api/RentPriceTrendSvc/v1/getJeonseRentChangeRateSize?page=1&perPage=20000&serviceKey=EfRw3aOGo7zd4ZuNdkbHJ4iopA%2F0dlXrGy%2Ft5y7573uHnQrrWeD9FXNlNgGtBLUVnokBHCbBUcrWdwGPaFsogg%3D%3D&type=json"
    date_ranges = [
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'APT_TYPE', 'SIZE_GBN', 'RATE', 'LEVEL_NO']
...
with DAG(
    dag_id = 'jeonse_rent_change_rate_size',
