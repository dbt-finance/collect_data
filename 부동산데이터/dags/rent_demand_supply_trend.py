...
schema = 'raw_data'
table = 'rent_demand_supply_trend'
...
def get_data():
    data_list = []
    base_url = "https://api.odcloud.kr/api/RentPriceTrendSvc/v1/getRentDemandSupplyTrend?page=1&perPage=20000&serviceKey=EfRw3aOGo7zd4ZuNdkbHJ4iopA%2F0dlXrGy%2Ft5y7573uHnQrrWeD9FXNlNgGtBLUVnokBHCbBUcrWdwGPaFsogg%3D%3D&type=json"
    date_ranges = [
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'GRADE_GBN', 'TREND_GBN', 'INDICES', 'LEVEL_NO']
...
with DAG(
    dag_id = 'rent_demand_supply_trend',
