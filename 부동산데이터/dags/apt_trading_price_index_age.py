...
schema = 'raw_data'
table = 'apt_trading_price_index_age'
...
def get_data():
    data_list = []
    base_url = "https://api.odcloud.kr/api/WeeklyAptTrendSvc/v1/getAptTradingPriceIndexAge?page=1&perPage=30000&serviceKey=EfRw3aOGo7zd4ZuNdkbHJ4iopA%2F0dlXrGy%2Ft5y7573uHnQrrWeD9FXNlNgGtBLUVnokBHCbBUcrWdwGPaFsogg%3D%3D&type=json"
    date_ranges = [
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'AGE_GBN', 'TR_GBN', 'INDICES', 'LEVEL_NO']
...
with DAG(
    dag_id = 'apt_trading_price_index_age',
