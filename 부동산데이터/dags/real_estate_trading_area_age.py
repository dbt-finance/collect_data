...
schema = 'raw_data'
table = 'real_estate_trading_area_age'
...
def get_data():
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'DEAL_OBJ', 'ALL_AREA', 'AGE01_AREA', 'AGE02_AREA', 'AGE03_AREA', 'AGE04_AREA', 'AGE05_AREA', 'AGE06_AREA', 'AGE07_AREA']
...
with DAG(
    dag_id = 'real_estate_trading_area_age',
