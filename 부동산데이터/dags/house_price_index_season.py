...
schema = 'raw_data'
table = 'house_price_index_season'
...
def get_data():
    data_list = []
    base_url = "https://api.odcloud.kr/api/HousePriceTrendSvc/v1/getHousePriceIndexSeason?page=1&perPage=25000&serviceKey=EfRw3aOGo7zd4ZuNdkbHJ4iopA%2F0dlXrGy%2Ft5y7573uHnQrrWeD9FXNlNgGtBLUVnokBHCbBUcrWdwGPaFsogg%3D%3D&type=json"
    date_ranges = [
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'APT_TYPE', 'TR_GBN', 'INDICES', 'LEVEL_NO']
...
with DAG(
    dag_id = 'house_price_index_season',
