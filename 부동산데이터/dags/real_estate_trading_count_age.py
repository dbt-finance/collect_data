...
schema = 'raw_data'
table = 'real_estate_trading_count_age'
...
def get_data():
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'DEAL_OBJ', 'ALL_CNT', 'AGE01_CNT', 'AGE02_CNT', 'AGE03_CNT', 'AGE04_CNT', 'AGE05_CNT', 'AGE06_CNT', 'AGE07_CNT']
...
with DAG(
    dag_id = 'real_estate_trading_count_age',
