...
schema = 'raw_data'
table = 'house_demand_supply_trend'
s3_key = 'data/real_estate/' + table + '/' + table

@task
def get_data():
    data_list = []
    base_url = "https://api.odcloud.kr/api/HousePriceTrendSvc/v1/getHouseDemandSupplyTrend?page=1&perPage=20000&serviceKey=EfRw3aOGo7zd4ZuNdkbHJ4iopA%2F0dlXrGy%2Ft5y7573uHnQrrWeD9FXNlNgGtBLUVnokBHCbBUcrWdwGPaFsogg%3D%3D&type=json"
    date_ranges = [
    ...
    # 필요한 컬럼 선택
    selected_columns = ['REGION_CD', 'REGION_NM', 'RESEARCH_DATE', 'APT_TYPE', 'BUY_DOM_INDICES', 'LEVEL_NO']
...
with DAG(
    dag_id = 'house_demand_supply_trend',
